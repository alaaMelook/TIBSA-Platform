...
// Create suspended-account folder in app/
...
if (!fs.existsSync(suspendedDir)) {
    ...
    console.log('✓ Created suspended-account directory');
}
...
// Write page.tsx
fs.writeFileSync(path.join(suspendedDir, 'page.tsx'), pageContent);
console.log('✓ Created app/suspended-account/page.tsx');
