...
const NAV_ITEMS = [
  { href: "/dashboard/infra-investigations",          label: "Scanner",  icon: <Globe className="w-3.5 h-3.5" /> },
  { href: "/dashboard/infra-investigations/history",   label: "History",  icon: <Clock className="w-3.5 h-3.5" /> },
  { href: "/dashboard/infra-investigations/reports",   label: "AI Reports", icon: <Sparkles className="w-3.5 h-3.5" /> },
  { href: "/dashboard/infra-investigations/settings",  label: "Settings", icon: <Sliders className="w-3.5 h-3.5" /> },
];
