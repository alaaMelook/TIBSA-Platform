        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }} className="space-y-6 max-w-[1400px]">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                    ...
                    <p className="text-sm text-[var(--text-muted)]">Monitor service status, resource usage, and system performance</p>
                </div>
                    ...
                    {services.map((service) => (
                        <div
                            ...
                            className={`flex items-start gap-4 p-4 rounded-xl border transition-colors ${
                                service.status === "operational"
                                    ? "bg-[var(--bg-elevated)] border-[var(--border-strong)] hover:border-emerald-500/20"
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-[var(--text-muted)] mt-0.5">{service.description}</p>
                                <div className="flex items-center gap-4 mt-2">
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-[11px] text-[var(--text-muted)]">Uptime</span>
                                        <span className="text-[11px] font-semibold text-[var(--text-secondary)]">{service.uptime}%</span>
                                    </div>
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-[11px] text-[var(--text-muted)]">Response</span>
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-[11px] text-[var(--text-muted)]">Checked</span>
                                ...
                                {/* Uptime bar */}
                                <div className="mt-2 w-full h-1 bg-[var(--bg-elevated)] rounded-full overflow-hidden">
                                    <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* CPU */}
                <div className="bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-xl p-5">
                ...
                <div className="bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-xl p-5">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-[var(--text-muted)]">Memory Usage</span>
                        <span className="text-lg font-bold text-[var(--primary)]">
                            {systemUsage.memory}%
                        </span>
                    </div>
                ...
                <div className="bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-xl p-5">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-[var(--text-muted)]">Disk Usage</span>
